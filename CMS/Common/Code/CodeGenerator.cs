    ...
    public class CodeGenerator
    {
        ...
        public CodeGenerator(IOptions<CodeGenerateOption> options)
        {
            ...
            if (_options.ConnectionString.IsNullOrWhiteSpace())
                throw new ArgumentNullException("未指定数据库链接.");
        ...
        {
            var modelPath = _options.OutputPath + Delimiter + "Model"; ;
        ...
        private string ReadTemplate(string templateName)
        {
            ...
            using (var stream = currentAssembly.GetManifestResourceStream($"{currentAssembly.GetName().Name}.Code.CodeTemple.{templateName}"))
            {
                if (stream != null)
                {
